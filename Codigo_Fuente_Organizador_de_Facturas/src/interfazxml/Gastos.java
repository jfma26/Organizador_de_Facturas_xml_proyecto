...
public class Gastos extends javax.swing.JFrame {
    ...
    public void obtenerTabla() throws SQLException {
        ...
        for(int i=1;i<=7;i++){
        String sentencia = "select sum(Detalle_Factura.Valor_Con_IVA) from Detalle_Factura, Factura where Cod_Tipo_Gasto='"+i+"'"
    ...
    public Gastos(String comprador) {
        Comprador=comprador;
        initComponents();
    ...
    private void LLenarCajasTexto() throws SQLException{
        ...
        while (resultado.next()) {
            ...
            jTextField6.setText(resultado.getString("Valor_Negocio"));
