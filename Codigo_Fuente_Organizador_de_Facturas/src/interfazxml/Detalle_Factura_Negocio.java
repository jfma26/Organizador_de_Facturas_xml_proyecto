...
public class Detalle_Factura_Negocio extends javax.swing.JFrame {
    ...
    public Detalle_Factura_Negocio(String factura, String proveedor, String comprador,String nombre) {
        initComponents();
        ...
        Comprador = comprador;
        Nombre=nombre;
        setTitle("Detalle Factura Negocio-"+nombre);
    ...
    public void obtenerTabla() throws SQLException {
        ...
        System.out.println(getTotalSinIVA());
        ActualizarFactura();
    }

    private void ActualizarFactura() {
        textoSql = "update organizador_facturas.Factura_Negocio set"
                + " Valor_Sin_IVA='" + getTotalSinIVA()
                + "' , IVA='" + getTotalIVA()
                + "' , Valor_Con_IVA='" + getTotalConIVA()
                + "' where Cod_Factura_Negocio='" + jTextField1.getText()
                + "' and RUC_Proveedor='" + jTextField2.getText() + "';";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (!jTextField1.getText().equals("") && !jTextField2.getText().equals("") && !tipoGasto.equals("")) {
            textoSql = "delete From detalle_factura_Negocio where Cod_Factura_Negocio='" + jTextField1.getText() + "' and RUC_Proveedor='" + jTextField2.getText() + "' and Cod_Tipo_Negocio='" + tipoGasto + "';";
            System.out.println(textoSql);
 ...
 if (CamposLLenos()) {
            try {
                ...
                Logger.getLogger(xml.Detalle_Factura.class.getName()).log(Level.SEVERE, null, ex);
            }
            LimpiarVentana();
            try {
                obtenerTabla();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        Factura_Negocio fac = new Factura_Negocio(Comprador,Nombre);
        fac.setVisible(true);
