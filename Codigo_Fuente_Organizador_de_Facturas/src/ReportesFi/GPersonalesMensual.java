...
public class GPersonalesMensual extends javax.swing.JFrame {
    private DefaultTableModel model;
    private String Comprador="";
    private String VMeses[]={"Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"};
    public GPersonalesMensual(String usuario) {
        Comprador=usuario;
        try {
            initComponents();
            setLocationRelativeTo(null);
            setTitle("Gastos Personales Mensual");
            llenarCombo();
    ...
    public void formatot() {
        ...
        String datos[][] = {};
        String Col[] = {"MES", "Vivienda","Educación"
                ,"Salud","Vestimenta","Alimentacion","Otros"};
    ...
    private void obtenerTabla() throws SQLException {
        ...
        for(int i=1;i<=6;i++){
        String sentencia = "select sum(Detalle_Factura.Valor_Con_IVA)"
                ...
                + "Factura.Fecha_Factura  BETWEEN '"+jComboBox1.getSelectedItem().toString()+"-"+j+"-01'  AND '"
                +jComboBox1.getSelectedItem().toString()+"-"+j+"-31' and Factura.RUCoCI_Comprador='"+Comprador+"';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GPersonalesMensual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
