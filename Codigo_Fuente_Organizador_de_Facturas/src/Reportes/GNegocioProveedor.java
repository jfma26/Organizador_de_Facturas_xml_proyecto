...
public class GNegocioProveedor extends javax.swing.JFrame {
    ...
    public GNegocioProveedor(String usuario) {
        ...
        try {
            ...
            setTitle("Gastos Negocio Por Proveedor");
            llenarCombo();
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            obtenerTabla(getcombopro(jComboBox1.getSelectedItem().toString()));
        } catch (SQLException ex) {
    ...
    public void obtenerTabla(String provee) throws SQLException {
        ...
        String sentencia = "select (select Nombre_Tipo_Negocio from tipo_Negocio where Cod_Tipo_Negocio='"+i+"'),sum(Detalle_Factura_Negocio.Valor_Sin_IVA),sum(Detalle_Factura_Negocio.IVA),sum(Detalle_Factura_Negocio.Valor_Con_IVA) from Detalle_Factura_Negocio,Tipo_Negocio,Factura_Negocio where Detalle_Factura_Negocio.Cod_Tipo_Negocio='"+i+"'"
                ...
                + "Detalle_Factura_Negocio.RUC_Proveedor='"+provee+"' and Factura_Negocio.RUCoCI_Comprador='"+Comprador+"';";
