...
public class GPersonalesAnual extends javax.swing.JFrame {
    ...
    public void obtenerTabla() throws SQLException {
        ...
        String sentencia = "select (select Nombre_Tipo_Gasto from tipo_gasto where Cod_Tipo_Gasto='"+i+"'),sum(Detalle_Factura.Valor_Sin_IVA),sum(Detalle_Factura.IVA),sum(Detalle_Factura.Valor_Con_IVA)"
                +" from Detalle_Factura,Tipo_Gasto,Factura where Detalle_Factura.Cod_Tipo_Gasto='"+i+"'"
