...
public class GPersonalesMensual extends javax.swing.JFrame {
    ...
    public GPersonalesMensual(String usuario) {
        ...
        try {
            ...
            setTitle("Gastos Personal Mensual");
            llenarCombo();
    ...
    public void obtenerTabla() throws SQLException {
        ...
        for (int i = 1; i <= 6; i++) {
            ...
            String sentencia = "select (select Nombre_Tipo_Gasto from tipo_gasto where Cod_Tipo_Gasto='" + i + "'),sum(Detalle_Factura.Valor_Sin_IVA),sum(Detalle_Factura.IVA),sum(Detalle_Factura.Valor_Con_IVA) from Detalle_Factura,Tipo_Gasto,Factura where Detalle_Factura.Cod_Tipo_Gasto='" + i + "'"
                    ...
                    + "Factura.Fecha_Factura  BETWEEN '" + jComboBox2.getSelectedItem().toString() + "-" + (jComboBox1.getSelectedIndex() + 1) + "-01'  AND '"
                    + jComboBox2.getSelectedItem().toString() + "-" + (jComboBox1.getSelectedIndex() + 1) + "-31' and Factura.RUCoCI_Comprador='" + Comprador + "';";
